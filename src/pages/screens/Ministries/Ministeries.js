...
import {
  ...
  DELETE_MINISTERIES_ACTION,
} from "../../../redux/actions/actions";
export default function Ministeries(props) {
  ...
  const { ministeries, ministry } = useSelector((state) => state.reducers);
          ...
          <table>
            <thead>
              <tr>
                ...
                <th data-heading="Name">Ministry Name</th>
                      ...
                      <tr key={item + index}>
                        ...
                        <td data-heading="Actions">
                          <div className="d-flex justify-content-between">
                            <button
                              onClick={(e) => {
                                dispatch(GET_MINISTERY_ACTION(item?._id));
                                // e.preventDefault(props.setPage("sermon_details"));
                                navigate(
                                  "/ministeries/ministery_details/" + item?._id
                                );
                              }}
